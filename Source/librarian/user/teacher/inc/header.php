...
// NOTIFICATION COUNT
$not = 0;
$res = mysqli_query($link,"SELECT * FROM message WHERE rusername='$teacher' AND read1='n'");
	...
	<div class="main-content">
		<div class="wrapper">
			<div class="left-sidebar">
				<div class="p-title">
					<h3><a href=""><i class="fas fa-book"></i><span>SLS</span></a></h3>
				</div>
